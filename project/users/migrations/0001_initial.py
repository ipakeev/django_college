    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_student', models.BooleanField(default=False, verbose_name='Является студентом')),
                ('is_social_auth', models.BooleanField(default=False, verbose_name='Через социальную сеть')),
